...
public:
  ...
  // Node CLI: `slots`, `stats-shared`, `slot N on|off`, `slot N <cmd>`.
  // Anything else falls through to slot 0, so the familiar repeater CLI still
  // works unqualified on a hydra node.
